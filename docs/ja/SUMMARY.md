...
- [Warder](./guide/warder.md)

# 標準ライブラリ

- [標準ライブラリリファレンス](./reference/stdlib.md)

# 設計メモ

以下は v0.0.1 current surface ではなく、設計メモです。

- [標準ライブラリアーキテクチャ](./STDLIB_ARCHITECTURE.md)
- [Temporal Affine Types](./TEMPORAL_AFFINE_TYPES.md)
- [Async / Concurrency Design](./ASYNC_CONCURRENCY_DESIGN.md)
