/* @ts-self-types="./restrict_lang.d.ts" */
 ...
 * @returns {any}
 */
export function compile_restrict_lang_with_modules(source, modules) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_restrict_lang_with_modules(ptr0, len0, modules);
    return ret;
}
