...
const CURRENT_CORE_DOCS: &[&str] = &[
    ...
    "docs/public/en/advanced/higher-order.md",
...
const CURRENT_JAPANESE_DOCS: &[&str] = &[
    ...
    "docs/public/ja/advanced/higher-order.md",
...
fn tracked_sources_do_not_reintroduce_legacy_function_declarations() {
    const ALLOWED_MIGRATION_OR_REJECTION_FILES: &[&str] = &[
        "LANGUAGE_SPECIFICATION.md",
        "tests/cases/test_fun_decl_parsing.rs",
        "tests/cases/test_release_example_hygiene.rs",
        "tests/cases/test_warder_hygiene.rs",
    ];
